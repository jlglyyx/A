 ...
 * @ClassName PictureProcessor
 * @Description
 * @Date 2021/12/21 14:32
 */
class PictureProcessor : IProcessor {

    private var prefixName = "Picture"
    private var fieldName = "mPicture"
    private var packageName = "picture"
