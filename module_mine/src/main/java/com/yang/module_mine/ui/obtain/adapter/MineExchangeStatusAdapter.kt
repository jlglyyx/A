 ...
 */
class MineExchangeStatusAdapter(layoutResId:Int , data: MutableList<MineObtainExchangeData>) : BaseQuickAdapter<MineObtainExchangeData, BaseViewHolder>(layoutResId,data) {

    override fun convert(helper: BaseViewHolder, item: MineObtainExchangeData) {
