//package com.yang.module_login.ui.fragment;
//
...
//
//        final TTSplashAd.AdInteractionListener listener = new SplashAdInteractionListener(this, mIsSplashClickEye, mSplashContainer);
//
...
//        public SplashAdInteractionListener(Activity activity, boolean isSplashClickEye, ViewGroup splashContainer) {
...
//            Log.d(TAG, "onAdSkip");
//            showToast(mContextRef.get(),"开屏广告跳过");
...
//            showToast(mContextRef.get(),"开屏广告倒计时结束");
//            goToMainActivity(mIsSplashClickEye, mSplashContainer);
//        }
//
...
//        }
//
//        private void goToMainActivity(boolean isSplashClickEye, ViewGroup splashContainer) {
...
//                    return;
//                } else {
//                    showToast(mContextRef.get(), "物料不支持点睛，直接返回到主界面");
...
//     */
//
//    private void useCustomCountdownButton(boolean isUseCustomCountdownButton, final TTSplashAd ad) {
